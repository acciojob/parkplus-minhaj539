...
public class ParkingLotController {
    ...
    public ResponseEntity<Spot> addSpot(@PathVariable int parkingLotId, @RequestParam("numberOfWheels") Integer numberOfWheels, @RequestParam("pricePerHour") Integer pricePerHour) {
    ...
    public ResponseEntity<Spot> updateSpot(@PathVariable int parkingLotId, @PathVariable int spotId, @RequestParam("pricePerHour") int pricePerHour) {
        //update the details of a spot
        Spot updatedSpot= parkingLotService.updateSpot(parkingLotId,spotId,parkingLotId);
